...
urlsfile = open('/home/sagnik/Downloads/test1.txt', "rb", 0)
...
first_line='zzzz'
os.makedirs('/home/sagnik/Downloads/testdir')
counter1=0
	...
	if line1[-4:]==first_line:
		...
		'''for i in line1:
			if i=='/':
				counter2=counter2+1
			if counter2==5:'''
		os.makedirs('/home/sagnik/Downloads/testdir/'+line1[90:92])	
	count=0
	print line1
 	first_line=line1[-4:]
	print ('first line'+first_line)
	urlsfile2 = open('/home/sagnik/Downloads/test1.txt', "rb", 0)
		...
		if line2[-4:] == line1[-4:] :
			...
			for j in line2:
				if j==' ':
					...
					counter3=counter3+1
			os.system('cp '+line2[0:counter3]+' '+'/home/sagnik/Downloads/testdir/'+line1[90:92])
			print 'yo'
			count=count+1
			print count
			#time.sleep(1000)
